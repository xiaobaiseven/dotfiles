...
borderpx不为0时，非活动窗口外边框颜色 static const char col_gray3[] = "#bd93f9";
//当前非活动的title字体颜色 static const char col_gray4[] = "#8be9fd";
//当前活动的title字体颜色 static const char col_cyan[] = "#111111";  //
title底色*/
...
static const char *chromecmd[] = {"vivaldi-stable",
